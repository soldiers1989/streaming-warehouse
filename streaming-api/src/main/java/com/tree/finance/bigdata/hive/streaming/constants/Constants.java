...
public interface Constants {
    ...
    String KEY_HBASE_INSERT_BATCH_SIZE = "recId.insert.batch.size";
    String KEY_HBASE_TABLE_NAME = "recId.table.name";
    ...
    String KEY_HBASE_DEFAULT_COLUMN_FAMILY = "recId.default.column.family";
    String KEY_HBASE_ZOOKEEPER_QUORUM = "hbase.zookeeper.quorum";
    String KEY_HBASE_RECORDID_TBL_SUFFIX = "_id";
    String KEY_HBASE_ZNODE_PARENT = "recId.znode.parent";

    String KEY_HBASE_CHECK_UPDATE_TIME_COL = "key.recId.fix.update.time.col";
    String KEY_HBASE_STREAM_UPDATE_TIME_COL = "key.recId.stream.update.time.col";
    String KEY_HBASE_SYS_CONF_TBL = "key.recId.sys.conf.tbl";
